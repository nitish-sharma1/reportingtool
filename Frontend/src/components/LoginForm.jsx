  ...
  return (
    <div className='flex w-full justify-between items-center'>
      <div className='p-10 w-1/2 '>
        ...
        <button className="w-full p-2 bg-grey-dark text-white rounded hover:bg-btn-purple">
          Sign-up
        </button>
        <button className="w-full rounded-full border border-grey-300 p-2 my-2 flex items-center justify-center bg-white text-grey-dark ">
